//This program is prepared by Khushi Shah
//ID:21CE127
...
public class Main {
    public static void main(String[] args) throws ExecutionException {
        Triplet<String, Integer, Character> p1 = Triplet.of("Khushi Shah", 20, 'F');
        Triplet<String, Integer, Character> p2 = Triplet.of("Siddhi", 25, 'F');
        Triplet<String, Integer, Character> p3 = Triplet.of("Dhair", 23, 'F');
